...
public class Simulator extends World
{
    ...
    {   
        ...
        addObject(new Label("Projected Mark", 30), 1050, 80);
        addObject(averageProjectedMark, 1050, 120);
        addObject(new Label("Anger Meter", 30), 1050, 160);
        addObject(cohenAngerMeter, 1050, 200);
        addObject(new Label("Computer Durability", 30), 1050, 240);
        addObject(computerDurability, 1050, 280);
        addObject(new Label("Mr. Cohen's Computer", 30), 1050, 420);
        janitorCounter = 1;
        blackScreen = new Fader("Blackscreen.png", 255, 1, 1);
        robber = null;
        setPaintOrder(Fader.class, Smokescreen.class, Janitor.class, MrCohen.class, Student.class, Puddle.class);
